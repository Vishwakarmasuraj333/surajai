...
import { Eye, EyeOff, Lock, Mail, User as UserIcon, ArrowRight, AlertCircle, Check, Sparkles, Layers } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#04040a] text-gray-100 flex flex-col justify-between relative overflow-hidden font-sans">
      ...
      <header className="p-6 md:p-8 relative z-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            ...
            <span>{showForm ? 'View Full Architecture' : 'Register Form'}</span>
          </button>
      ...
      {!showForm && (
        ...
        >
          ...
          <span>Viewing SurajAI Architecture Nodes • Tap to Open Registration</span>
        </div>
      )}
